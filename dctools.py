...
def getTrade(data):
    ...
    start_transcation_type = ['<Sell_New>', '<Buy_New>', '<SellShort_New>', '<CoverShort_New>', '<ForwardFX_New>', '<Sell_Delete>', '<Buy_Delete>']
    end_transcation_type = ['</Sell_New>', '</Buy_New>', '</SellShort_New>', '</CoverShort_New>', '</ForwardFX_New>', '</Sell_Delete>', '</Buy_Delete>']
    indices = []
    details = []
    indices2 = []
    details2 = []
